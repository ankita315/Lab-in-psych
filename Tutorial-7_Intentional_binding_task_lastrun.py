...
expName = 'Tutorial-7_Intentional_binding_task'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='K:\\kavyan\\Psychopy projects\\Tutorial-7_Intentional_binding_task_lastrun.py',
...
trials = data.TrialHandler(nReps=5.0, method='random', 
    ...
    trialList=data.importConditions('C:/Users/Kai/Downloads/Untitled spreadsheet - Sheet1 (2).csv'),
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        if polygon_2.status == NOT_STARTED and tThisFlip >= 1-frameTolerance:
            # keep track of start time/frame for later
